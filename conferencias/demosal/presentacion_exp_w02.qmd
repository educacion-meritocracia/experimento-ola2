...
plot_es <- datos %>% filter(p2_1_o2=="De acuerdo") %>% 
  dplyr::select(exp_t4_d_rec:exp_t4_a_rec) %>%
  plot_stackfrq(show.total=FALSE,
                axis.labels=rev(c("A.", "B.", "C.", "D.")),
    geom.colors = c("#E74C3C", "#2E86C1")) + 
...
plot_ec <- datos %>% filter(p1_1_o2=="De acuerdo") %>% 
  dplyr::select(exp_t4_d_rec:exp_t4_a_rec) %>%
  plot_stackfrq(show.total=FALSE,
                axis.labels=rev(c("A.", "B.", "C.", "D.")),
    geom.colors = c("#E74C3C", "#2E86C1")) + 
...
ggarrange(plot_es, plot_ec, common.legend = TRUE, nrow=2, legend = c("bottom", "right"))
...
ggarrange(plot_ts, plot_tc, common.legend = TRUE, nrow=2, legend = c("bottom", "right"))
...
ggarrange(plot_ms, plot_mc, common.legend = TRUE, nrow=2, legend = c("bottom", "right"))
